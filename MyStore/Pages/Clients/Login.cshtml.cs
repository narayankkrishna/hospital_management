...
namespace MyStore.Pages.Clients
{
	public class LoginModel : PageModel
	{
		...
		public string loginemail = "pbadmin@bphospital.com";
		public string loginpassword = "Bphospital@1";
		...
		public void OnPost()
		{
			...
			if (loginInfo.name.Length == 0 || loginInfo.email.Length == 0 || loginInfo.password.Length == 0 ||
				loginInfo.name != "Narayan" || loginInfo.email != "narayan@gmail.com" || loginInfo.password != "123456")
			{
